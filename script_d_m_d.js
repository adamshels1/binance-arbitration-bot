...
const data = fs.readFileSync(path.resolve(__dirname, 'data_d_m_d.txt'), 'utf8')
...
async function run() {
    ...
    const calcEl = (symbols, amount = 0, check = true) => {
        ...
        const res_3 = ('/') ? (res_2 / el_3d.askPrice) : (res_2 * el_3m.bidPrice);
        ...
        const OFFER_3 = {
            amount: el_3d.askQty * b_usd_3.price,
        ...
        if (PROFIT) {
            ...
            if (!check) {
                ...
                if (PROFIT > 0) {
                    ...
                    console.log('el_3d', el_3d);
                    console.log('el_3d', el_3d.symbol);
                    console.log(`OFFER_3 ${b_usd_3.symbol} : `, `${el_3d.askQty} * ${b_usd_3.price} = ${el_3d.askQty * b_usd_3.price}`);
                    console.log(OFFER_1);
                    console.log(OFFER_2);
                    console.log(OFFER_3);
                    ...
                    if (!check) console.log(`${res_2} * ${el_3d.askPrice} = ${res_2 * el_3d.askPrice}`);
                    console.log('----------------------------------');
