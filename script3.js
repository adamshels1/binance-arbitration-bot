...
const START_AMOUNT_FOR_UST = 5.5; //USD
const START_AMOUNT_OLD = 14.3; //USDT, PAX, TUSD, USDC
let TOTAL_AMOUNT = 0;
let SUCCESS_EL_LENGTH = 0;
let BALANCE = 80;

const getStartAmount = (b0) => {
    if (b0 === 'USDT' || b0 === 'PAX' || b0 === 'TUSD' || b0 === 'USDC') {
...
async function run() {
    ...
    const calcEl = (symbols, amount = 0, check = true) => {
        ...
        const START_AMOUNT = getStartAmount(b[0]);
